...
\centering
    \begin{minipage}[t]{0.45\textwidth}
        \centering
            ...
            \subcaption[fir]{Start of internal waves attractor formation $t=0$ to $8\,T_0$}
        \label{fig:LamAttr}
    \end{minipage}
    \begin{minipage}[t]{0.45\textwidth}
        \centering
            ...
            \subcaption[sec]{Internal wave turbulence $t=360\,T_0$}
        \label{fig:turbAttr}
    \end{minipage}
...
\centering
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \subcaption[fir]{Initial stage from $t=0$ to $8\,T_0$}
%        \subcaption[fir]{Sedimentation from $t=0\,s$ to $t=80\,s$}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        ...
        \subcaption[sec]{Dynamics of the particles for $t=360\,T_0$}
...
%        \subcaption[fir]{Sedimentation from $t=0\,s$ to $t=80\,s$}
        \subcaption[fir]{Initial stage from $t=0$ to $t=8\,T_0$}
        \label{fig:turbSed2Da}
    \end{minipage}
    \begin{minipage}[t]{0.45\textwidth}
        \centering
