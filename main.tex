...
\centering
    \begin{minipage}[t]{0.45\textwidth}
        ...
        %\animategraphics[autoplay,loop,scale=0.125]{10}{Figs/AttrctorSlipLaminarSediment/SlipLam.0}{000}{159}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        %\animategraphics[autoplay,loop,scale=0.125]{10}{Figs/AttrctorSlipLaminarMid/SlipLam.07}{40}{79}
